...
public class WarehouseConcurrencyIT {
  ...
  public void testConcurrentReadsAreNonBlocking() throws InterruptedException {
    ...
    createWarehouseInNewTransaction("READ-TEST-001", "AMSTERDAM-001", 100, 50);
  ...
  void createWarehouseInNewTransaction(String businessUnitCode, String location, int capacity, int stock) {
    Warehouse warehouse = new Warehouse();
